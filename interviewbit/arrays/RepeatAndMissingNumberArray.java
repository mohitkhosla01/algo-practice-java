...
//		A.add(3);
		...
		System.out.print(new RepeatAndMissingNumberArray().repeatedNumber(A));
	}
    ...
    public ArrayList<Integer> repeatedNumber(List<Integer> A) {
    	...
    	long expectedSum = (long)((AA.size() * (AA.size()+1))/2);
    	long totalSum = 0;
    	
    	for(int i=0; i<AA.size(); ++i) {
    		totalSum += (long)(Math.abs(AA.get(i)));
    		
    		int t = (Math.abs(AA.get(i))) - 1;
    		if(AA.get(t) > 0) {
    			AA.set(t, AA.get(t)*-1);
    		}
    		else {
